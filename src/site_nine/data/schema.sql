...
-- HANDOFFS TABLE
-- ============================================================================
-- Tracks work handoffs between possessions and roles
    ...
    SELECT
        ...
        CASE
            ...
            WHEN EXISTS (
                ...
                WHERE h.task_id = t.id AND h.deleted_at IS NULL
            ) THEN 'HANDOFF (pending)'
...
-- DAEMON SEED DATA
-- ============================================================================
-- Christian-tradition daemon name pool, role-bound.
-- daemonology and personality are NULL on creation; generated by LLM on first summon.

-- Administrator (sovereign, commanding, ambitious)
INSERT OR IGNORE INTO daemons (name, role) VALUES
    ('Lucifer',       'Administrator'),
    ('Mephistopheles','Administrator'),
    ('Belial',        'Administrator'),
    ('Mammon',        'Administrator'),
    ('Beelzebub',     'Administrator'),
    ('Abaddon',       'Administrator'),
    ('Samael',        'Administrator');

-- Architect (builder, shaper, maker of forms)
INSERT OR IGNORE INTO daemons (name, role) VALUES
    ('Asmodeus',      'Architect'),
    ('Belphegor',     'Architect'),
    ('Dagon',         'Architect'),
...
-- Engineer (craftsman, technician, precise and relentless)
INSERT OR IGNORE INTO daemons (name, role) VALUES
    ('Azazel',        'Engineer'),
    ('Raum',          'Engineer'),
    ('Furcas',        'Engineer'),
    ...
    ('Phenex',        'Engineer'),
    ('Halphas',       'Engineer'),
    ('Andromalius',   'Engineer');

-- Tester (prober, doubter, seeker of flaws)
INSERT OR IGNORE INTO daemons (name, role) VALUES
    ('Astaroth',      'Tester'),
    ('Agares',        'Tester'),
    ('Barbatos',      'Tester'),
...
-- Documentarian (chronicler, lorekeeper, recorder of deeds)
INSERT OR IGNORE INTO daemons (name, role) VALUES
    ('Vassago',       'Documentarian'),
    ('Sitri',         'Documentarian'),
    ('Paimon',        'Documentarian'),
    ('Gusion',        'Documentarian'),
    ('Marbas',        'Documentarian'),
    ('Valefor',       'Documentarian'),
    ('Amon',          'Documentarian');

-- Designer (shaper of beauty, conjurer of form)
INSERT OR IGNORE INTO daemons (name, role) VALUES
    ('Focalor',       'Designer'),
    ('Vepar',         'Designer'),
    ('Sabnock',       'Designer'),
...
-- Inspector (watcher, judge, exposer of corruption)
INSERT OR IGNORE INTO daemons (name, role) VALUES
    ('Haagenti',      'Inspector'),
    ('Crocell',       'Inspector'),
    ('Murmur',        'Inspector'),
    ('Caim',          'Inspector'),
    ('Glasya-Labolas','Inspector'),
    ('Zagan',         'Inspector'),
    ('Bathin',        'Inspector');

-- Operator (executor, keeper of systems, maintainer of order)
INSERT OR IGNORE INTO daemons (name, role) VALUES
    ('Forneus',       'Operator'),
    ('Ronove',        'Operator'),
    ('Berith',        'Operator'),
...
-- Historian (rememberer, keeper of records, narrator of time)
INSERT OR IGNORE INTO daemons (name, role) VALUES
    ('Stolas',        'Historian'),
    ('Malphas',       'Historian'),
    ('Foras',         'Historian'),
