...
3. **Role validation:**
   ...
   - Valid roles: Administrator, Architect, Engineer, Tester, Documentarian, Designer, Inspector, Operator
...
- [ ] `/new Engineer` - Creates session AND starts session-start with Engineer
