...
s9 task create --title "Test task 1" --role Builder --priority HIGH --epic EPC-H-0002
# Result: ✓ Created task BLD-H-0059: Test task 1
#         Linked to epic: EPC-H-0002

# Test 2: Create task without epic, then link
s9 task create --title "Test task 2" --role Builder --priority MEDIUM
# Result: ✓ Created task BLD-M-0060: Test task 2

s9 task link BLD-M-0060 EPC-H-0002
# Result: ✓ Linked task BLD-M-0060 to epic EPC-H-0002

# Verify epic shows both tasks
s9 epic show EPC-H-0002
# Result: Shows 2 subtasks (BLD-H-0059 and BLD-M-0060)

# Test 3: Unlink task
s9 task unlink BLD-M-0060
# Result: ✓ Unlinked task BLD-M-0060 from epic EPC-H-0002

# Verify task removed from epic
s9 epic show EPC-H-0002
# Result: Shows only 1 subtask (BLD-H-0059)
```
...
- EpicManager already had link_task/unlink_task methods (implemented in task BLD-H-0034)
