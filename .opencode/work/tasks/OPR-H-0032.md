# Task OPR-H-0032: Entity Model Refactor - Personas, Missions, and Clear Terminology
...
- CLI commands can stay as `s9 agent` (it's a good name for the concept)
...
1. Update `s9 agent` commands (or rename to `s9 session`)
