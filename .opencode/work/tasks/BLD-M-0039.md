...
s9 dashboard --role Builder
# Result: Shows only Builder tasks (epics section not shown in role view)
...
- This completes the epic system feature set for Builder role