# Task ENG-H-0035: Implement epic CLI commands (create, list, show, update, abort)
...
- Epic ID generation was already implemented in `src/site_nine/epics/epic_ids.py` (completed in ENG-H-0034)
